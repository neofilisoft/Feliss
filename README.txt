...
Feliss Engine is a C++ game engine codebase with a shared engine core, a dedicated editor, and a separate runtime executable.
...
See [LICENSE.txt](C:/Users/BEST/Desktop/FelissEngine/LICENSE.txt).

Licensing summary:

- Feliss source code is proprietary and may not be modified without a separate written agreement.
- Individual: free, 3% royalty, paid assets not included.
- Pro: USD 160 per seat per year, 3% royalty after the first USD 1,000, selected paid assets included where marked.
- Enterprise: USD 1,100 per 20 seats per year, 1.5% royalty after the first USD 5,000, paid assets included per plan terms.
- Royalties apply to qualifying gross revenue from the base game, DLC/expansions, subscriptions, and microtransactions.
