#pragma once
// =====================================================================
// D3D11Backend — DirectX 11 stub (Windows only)
// Full implementation requires: Windows SDK, d3d11.lib, dxgi.lib
// =====================================================================
#include "renderer/IRendererBackend.h"

namespace Feliss {

class D3D11Backend : public IRendererBackend {
public:
    ...
    const char* apiName()  const override { return "DirectX 11"; }
    RenderAPI   api()      const override { return RenderAPI::DirectX11; }
