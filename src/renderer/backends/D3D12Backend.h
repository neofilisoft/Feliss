#pragma once
// =====================================================================
// D3D12Backend — DirectX 12 stub (Windows only)
// Full implementation requires: Windows SDK d3d12.lib, dxgi.lib, d3dcompiler.lib
// =====================================================================
#include "renderer/IRendererBackend.h"

namespace Feliss {

class D3D12Backend : public IRendererBackend {
public:
    ...
    RenderAPI   api()      const override { return RenderAPI::DirectX12; }
