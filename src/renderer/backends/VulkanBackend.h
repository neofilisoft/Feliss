#pragma once
// =====================================================================
// VulkanBackend — Vulkan 1.3 stub
// Full implementation requires: Vulkan SDK, VMA, spirv-cross
// =====================================================================
...
public:
    ...
    const char* apiName()  const override { return "Vulkan 1.3"; }
    RenderAPI   api()      const override { return RenderAPI::Vulkan; }
    ...
    GpuHandle createComputeShader(const char*)  override { return NULL_GPU_HANDLE; }
    void      dispatchCompute(GpuHandle,u32,u32,u32) override {}
